<?php 
/**
@Page/Module Name/Class: 		printReceipt.php
@Author Name:			 		Alan Anil
@Date:					 		Dec, 19 2013
@Purpose:		        		display and print the transaction receipt
@Table referred:				NIL
@Table updated:					NIL
...
<?php if(isset($result) && !empty($result)): ?>
	<div class="publicTitle">
		<h1>View  receipt #<?php echo $result->ppID; ?></h1>
	</div> 
	<div id="form" class="view">
		...
		<?php if(PAYMENT_ENROLLED == $result->payment_status || PAYMENT_COMPLETED == $result->payment_status ): ?>
			<div class="row clearfix">
