...
<div class="backButton clearfix">
	 <?php echo anchor('edu_admin/assignment/index?course_id='.$this->input->get('assignCnfID'),'Back','class="submit"'); ?> 
</div>
<script>
    tinymce.init({
	...
	<form class="form" action="" method="post" >
		...
		<?php if(isset($courses) && !empty($courses)): ?>
			...
			<?php 
				...
				?>
					<?php $course_location=$course->csCity.', '.$course->csState;
						if(COURSE_ONLINE == $course->csCourseType)
							$course_location='Online';
					?>
					<option  <?php echo $selected; ?> value="<?php echo $course->csID ?>" /><?php echo $course->cdCourseID.' '.$course->cdCourseTitle.'('.format_date($course->csStartDate,DATE_FORMAT).'-'.format_date($course->csEndDate,DATE_FORMAT).'-'.$course_location.')'; ?></option>
				<?php }?>
				</select>
