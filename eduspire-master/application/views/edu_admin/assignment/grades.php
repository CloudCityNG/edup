...
//---------------------------------------------------------------------------------------- 
 */
$getAssignDetail = $this->assignment_model->getAssignDetails($assignId); 
?> 
<div class="adminTitle"><h1>Assignment Grades: <?php echo $getAssignDetail[0]->assignTitle;?> </h1></div>
...
<div>
     <?php if(isset($userList) && count($userList)>0): ?>  
        ...
        <form method="post" name="userLists" action="" onsubmit="return checkAllPointsVal();">
           <table class="table striped"  cellspacing="0" cellspacing="0"  width="100%" id="grid"> 
            <tr>  
                <th>Registrant</th>
                <th></th>
                <th>Submitted</th>
